...
// Emoji pool – corrected syntax (all quotes properly closed)
...
async function handleAreactCommand(sock, chatId, message, isOwner) {
    try {
        ...
        if (action === 'on') {
            ...
            await sock.sendMessage(chatId, {
                text: '✅ Auto‑reaction *enable* kar diya gaya! Ab har command pe reaction milega.',
                contextInfo: getNewsletterInfo()
            }, { quoted: message });
        } else if (action === 'off') {
            ...
            await sock.sendMessage(chatId, {
                text: '❌ Auto‑reaction *disable* kar diya gaya.',
                contextInfo: getNewsletterInfo()
            }, { quoted: message });
        } else {
